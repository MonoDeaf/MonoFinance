export const Header = (userEmail = 'guest@mono.finance') => `
    <header class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center gap-4 relative">
             <div id="user-menu-trigger" class="flex items-center gap-3 bg-[#141414] rounded-full pl-1 pr-3 py-1 border border-white/10 cursor-pointer hover:bg-white/5 transition-colors group">
                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-[#ccccfa] to-[#5555aa] p-[1px]">
                    <img src="avatar-miguel.png" alt="User" class="w-full h-full rounded-full object-cover border border-black pointer-events-none">
                </div>
            ...
            <!-- User Dropdown Menu -->
            <div id="user-dropdown" class="hidden absolute top-full right-0 mt-3 w-48 bg-[#0f0f0f] border border-white/10 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] z-[60] py-2 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                <div class="px-1">
                    <button class="w-full flex items-center gap-3 px-3 py-2 text-xs text-gray-400 hover:text-white hover:bg-white/5 transition-all rounded-lg">
