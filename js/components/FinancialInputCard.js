export const FinancialInputCard = () => `
    <div class="card h-full p-4 sm:p-8 flex flex-col">
        <div class="mb-8">
        ...
        <form id="financial-form" class="flex-1 space-y-6">
            ...
            <div>
                ...
                <select id="input-category" class="w-full input-base rounded-md py-3 px-3 text-sm focus:outline-none focus:border-[var(--accent-primary)]/50 transition-colors appearance-none cursor-pointer">
            ...
            <div>
                ...
                <input type="text" id="input-label" class="w-full input-base rounded-md py-3 px-4 text-sm focus:outline-none focus:border-[var(--accent-primary)]/50 transition-colors" placeholder="e.g. BTC Wallet, Chase Checking...">
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" id="input-amount" required class="w-full input-base rounded-md py-3 pl-8 pr-4 text-sm focus:outline-none focus:border-[var(--accent-primary)]/50 transition-colors" placeholder="0.00">
                </div>
            </div>

            <div class="pt-4">
                <button type="submit" class="w-full py-4 btn-primary text-sm font-bold rounded-md transition-all transform active:scale-95">Add to Money Power</button>
            </div>
        </form>
